...
class PollsTest(LiveServerTestCase):
    ...
    def test_can_create_new_poll_via_admin_site(self):
        ...
        # She types in a interesting question for the Poll
    ...
    def _setup_polls_via_admin(self):
        # Gertrude logs into athe admin site
        self.browser.get(self.live_server_url + '/admin/')
        username_field = self.browser.find_element_by_name('username')
        username_field.send_keys('admin')
        ...
        for poll_info in (POLL1, POLL2):
            ...
            # Enters its name, and users the 'today' and 'now' buttons to set
            # the publish date
            question_field = self.browser.find_element_by_name('question')
            ...
            # Is retrund to the "Polls" listing, where she can see her
    ...
    def test_voting_on_a_new_poll(self):
        # Frist, Gertrude the administrator logs into the admin site and
        # creates a couple of new Polls, and their response choices
        self._setup_polls_via_admin()

        # Now, Hervert hte regular user goes to the homepage of the site. He
        ...
        # 'How awesome is test-drivern development?'
        ...
        # Ehere are three options with radio buttons
